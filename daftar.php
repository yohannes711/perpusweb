...
<head>
  ...
  <meta name="description" content="PerpusE-book">
  <meta name="perpusE-book" content="PerpusE-book">
...
<body background="img/background.jpg">
  ...
  <div class="container">
    ...
    <form class="form-signin" action="insert-anggota.php" method="post">
      <center>
        <h2 class="form-signin-heading"><span class="glyphicon glyphicon-th-large"></span> PerpusE-book </h2>
      </center>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p> PerpusE-book adalah salah satu layanan bagi pengguna untuk dapat mengakses berbagai buku bacaan yang dan
            dilakukan kapan saja dan dari mana saja, dengan menggunakan jaringan internet.</p>
          <p> PerpusE-book memiliki koleksi buku dalam bentuk format digital dan bisa diakses dengan komputer. koleksi
            bacaan dari PerpusE-book dapat diakses dengan cepat dan mudah lewat jaringan komputer.</p>
          <p> PerpusE-book bebasis website yang responsif, untuk info, saran, maupun kritik bisa menghubungi kami :
          </p>
          <table>
            <tr>
              <td>E-mail</td>
              <td>:</td>
              <td><a href="sisteminformasi494@gmail.com">PerpusE-book@gmail.com</a></td>
            </tr>
            <br />
            <tr>
              <td>Blog</td>
              <td>:</td>
              <td><a href="#" target="_blank">www.PerpusE-book.com</a></td>
            </tr>
            <br />
            <tr>
              <td>Website</td>
